...
output_file = r"C:\Users\carrie\Documents\CIS_598_Capstone\FeatureSelectionResults\CDSOnly\HopefullyAllDataFeatureSelection5Features.txt"
...
with open(output_file, 'w') as f:
    for feat in data:
        ...
        f.write(f"Selected features by f_regression:\n {selected_features_f_reg}")
        f.write("")
        ...
        f.write(f"\nSelected features by mutual_info_regression:\n {selected_features_mutual_info}")
        f.write("")
